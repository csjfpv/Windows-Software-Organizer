...
export const demoConfig: AppConfig = {
  ...
  apps: [
    ...
    { id: 'demo-web', categoryId: 'utilities', name: '项目主页', description: '打开公开项目页面', target: 'https://github.com/csjfpv/Windows-', targetType: 'url', args: [], workingDirectory: '', iconPath: '', order: 0, launchCount: 1, lastLaunchedAt: null }
  ]
};
